...
public class FavoriteMoviesContentProvider extends ContentProvider {
    ...
    private static final int REVIEWS_WITH_MOVIE_ID = 102;
    private static final int VIDEOS_WITH_MOVIE_ID = 103;
    private static final int REVIEW_WITH_ID = 201;
    private static final int VIDEO_WITH_ID = 301;
